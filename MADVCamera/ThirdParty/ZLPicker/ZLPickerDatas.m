...
- (void) getAllGroupWithPhotos : (callBackBlock ) callBack{
    ...
    NSInteger type = ALAssetsGroupAll;///!!!ALAssetsGroupLibrary | ALAssetsGroupAlbum | ALAssetsGroupEvent | ALAssetsGroupFaces | ALAssetsGroupSavedPhotos | ALAssetsGroupPhotoStream;
