...
//        [self.skipBtn setTitle:[NSString stringWithFormat:@"%@ | 跳过",@(_adTime--)] forState:UIControlStateNormal];
        [self.skipBtn setTitle:FGGetStringWithKeyFromTable(SKIP, nil) forState:UIControlStateNormal];
    }
}
...
//    UIImage * launchImage = [UIImage imageNamed:launchImageName];
    self.backgroundColor = [UIColor colorWithHexString:@"#46A4EA"];
    //self.backgroundColor = [UIColor whiteColor];
    ...
    self.skipBtn.frame = CGRectMake(mainWidth - 90, 30, 70, 30);
//    self.skipBtn.backgroundColor = [UIColor colorWithHexString:@"#212121" alpha:0.3];
