...
typedef struct AVLutz {
    int64_t offset;         ///< offset of lutz data
    int64_t size;           ///< size of lutz data
} AVLutz;
...
#define RAW_PACKET_BUFFER_SIZE 2500000
    ...
    /**
     * Output lutz table offset.
     */
    struct AVLutz lutz;
    
    /**
     * gyro data dummy line number.
     */
    int gyro_dummy_lines;
    ...
    /**
     * gyro data size per frame.
     */
    int gyro_size_per_frame;
    ...
    /**
     * cut data size per cut point.
     */
    int cut_size_per_point;
    ...
    /**
     * Share bitrate content or not.
     */
    boolean_t is_share_bitrate_content;
    
    /**
     * moov box "size" section offset.
     */
    int64_t moov_box_size_offset;
    
    /**
     * video trak box "size" section offset.
     */
    int64_t video_trak_box_size_offset;
    
    /**
     * video trak box end offset.
     */
    int64_t video_trak_box_end_offset;
    
    /**
     * flag just for parsing video_trak_box_xxx usage.
     */
    boolean_t bVideoTrakFound;
